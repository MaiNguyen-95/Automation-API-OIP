...
Feature: B2C Order API
    ...
    Scenario Outline: B2C Create Order - Authentication <token_status>
        Given I am '<token_status>' authenticated on 'order_service' service for '<countryCode>' country
    ...
    Scenario Outline: B2C Create Order - <country>
        Given I am 'valid_token' authenticated on 'order_service' service for '<country>' country
    ...
    Scenario: B2C Create Order ID - Delivery
        Given I am 'valid_token' authenticated on 'order_service' service for 'id' country
        And I build dynamic payload from "b2cCreateOrder" with:
            | key                               | value                                |
